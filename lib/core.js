(function() {
  ...
  module.exports = function(token, url, vers) {
    var api_url, defaultVers, default_api_url, get, post;
    ...
    post = function(url, data, callback) {
      var parsedUrl, pathstr, post_callback, request, result;
