(function() {
  ...
  exports = module.exports = function(token, url, ver) {
    ...
    get_subscriber = function(msidn, keyword_id, callback, verOverride) {
      var params, version;
      version = verOverride || null;
      params = {
        'msidn': msidn,
    ...
    update_subscriber = function(msidn, subscriber_id, keyword_id, shortcode, addtl, callback, passthrough, verOverride) {
      var doc, fields, version, xml_payload;
      version = verOverride || null;
      if (addtl && typeof addtl === 'object') {
        fields = addtl;
